...
After enabling GitHub Pages, your project will normally be available at:

```text
https://YOUR-GITHUB-USERNAME.github.io/EDOS-Python-Learning-Desktop/
```

Replace `YOUR-GITHUB-USERNAME` with your GitHub username if your repository name is `EDOS-Python-Learning-Desktop`.
