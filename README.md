...
---
🌐 Live EDOS
▶️ Launch EDOS — Python Learning Desktop
Live website:  
...
Open EDOS online.
Open Python IDLE or Jupyter Notebook from the desktop.
...
```
Press Run.
Read the output and experiment.
...
See `LICENSE.md` for the project terms.
